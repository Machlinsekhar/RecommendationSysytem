...
import recom from '../image/recom1.png';
import plate from '../image/recom1.png';
...
const SignUp = () => {
  ...
  const plate1Style = {
    position: 'fixed',
    top: -220,      // Set top to 0 to align with the top edge
    left: -110,     // Set left to 0 to align with the left edge
    transform: 'scale(0.81) rotate(-20deg)', // Remove the translation to keep it at the top left corner
    zIndex: 1,
    opacity: 0.9,
};
  ...
  return (
    ...
    <TitleBlock
      ...
      />
        ...
        <Link to={'/'} style={linkStyle}>Already existing user? Click here! </Link>
      </div>
      </div>
    </div>
  );
